...
with col2:
    ...
    st.write("***Eng. Nadia Khaled Abd Elsamea***")
...
geography = st.sidebar.selectbox('Pick your Geography', ['Germany', 'Spain', 'France'])
...
isActiveMember = st.sidebar.radio('Active Member', ['Yes', 'No'], horizontal=True)
